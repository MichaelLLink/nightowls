...
public class Sprint4 {
    ...
    public static void main(String[] args)
    {
        ...
        //robot.runMotor(RXTXRobot.MOTOR3, 100, 7000);  //partially raise boom
        ...
        turn(left);            //turn into gap
         ...
         moveTillSense(30);     //move till we're close enough to back wall
        ...
        //robot.runMotor(RXTXRobot.MOTOR1, 10, RXTXRobot.MOTOR2, -500, 1650);
         ...
         speedL = slowL;
         speedR = slowR;
         moveTillSense(1);          //run into the soil container
...
/*
        if(direction == 1) //left
        {
            ...
            while(!turned)
            {
                ...
                if(ticks > -150)
                {
                    robot.runMotor(RXTXRobot.MOTOR1, -350, RXTXRobot.MOTOR2, -350, 500);
                }
                if(ticks < -160)
                {
                    robot.runMotor(RXTXRobot.MOTOR1, 350, RXTXRobot.MOTOR2, 350, 500);
    ...
    {
        robot.runMotor(RXTXRobot.MOTOR3,250,1000);
    }
    ...
    private static void senseGap()
    {
        ...
        robot.runMotor(RXTXRobot.MOTOR1, speedL, RXTXRobot.MOTOR2, -speedR, 600);
    }
